...
Gates 1 and 2 are merged on current `main` at `2f8dae22b6b2673c75e94d66985e749a303b92df`. Gate 3 now has a frozen product/model contract, prediction-specific literature review, G3-BENCH-V1 protocol, and a dated implementation-ready plan. D-013 still blocks real benchmark outcome viewing/promotion until its remaining dataset/consent/statistical authority is recorded; D-012 blocks production feature exposure.
